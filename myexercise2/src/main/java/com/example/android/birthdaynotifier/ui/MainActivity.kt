...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadPersonDataInList() {
        ...
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Max Mustermann", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Maria Musterfrau", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Stefan Müller", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Theresa Huber", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Manuel Bauer", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Stefanie Müller", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Hansi Hansmann", "01.02.1970"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Max Mustermann", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Maria Musterfrau", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Stefan Müller", "01.09.1999"))
        contactList.add(Person(R.drawable.ic_person_black_24dp, "Theresa Huber", "01.09.1999"))
